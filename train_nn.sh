...
#BSUB -q gpua100
### -- set the job Name --
#BSUB -J _nodam_30nt_1600orgs_8000frag_
...
#BSUB -o job_output/_nodam_30nt_1600orgs_8000frag_.out
#BSUB -e job_output/_nodam_30nt_1600orgs_8000frag_.err
# -- end of LSF options --
...
python3 -m src.training_model.training

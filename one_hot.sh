...
script="src.data_preparation.encode_numbers"
...
python -m $script $file_name $data_folder $base_dir_save $train_seq_no $val_seq_no $test_seq_no $limit_train_orgs $limit_val_orgs $limit_test_orgs $sequence_max_length

...
class TheOneAndOnly(nn.Module):
    def __init__(self,  sequence_length = 60, first_channels_conv = [20, 40, 80, 80, 120], last_channels_conv = [40, 80, 80, 120]): # horizontal kernel with horizontal stride
        ...
        self.third_conv = nn.Sequential(
            nn.Conv2d(in_channels=first_channels_conv[2],
